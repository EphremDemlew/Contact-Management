<template>
  <button
    @click="navigate"
    class="bg-white border border-white p-2 rounded text-gray-700 flex items-center focus:outline-none focus:shadow-outline"
  >
      ...
      <div class="lg:w-4/6 mx-auto">
        <div class="rounded-lg h-64 overflow-hidden">
          <img
            ...
            src="../assets/undraw_complete_design_re_h75h.svg"
          />
        </div>
        <div class="flex flex-col sm:flex-row mt-10">
          <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
            ...
            <div class="flex flex-col items-center text-center justify-center">
              ...
              <p class="text-base text-gray-400">Phone Number</p>
            </div>
          </div>
          <div
          ...
          >
            <p class="leading-relaxed text-lg mb-4">
              Details about the person is writteen here.
            </p>
